...
void q_ludo_player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<q_ludo_player *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (q_ludo_player::*)(int );
        ...
        {
            using _t = void (q_ludo_player::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject q_ludo_player::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_q_ludo_player.data,
    qt_meta_data_q_ludo_player,
    qt_static_metacall,
    nullptr,
    nullptr
} };
